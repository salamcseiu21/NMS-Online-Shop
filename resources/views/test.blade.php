...
<head>
  ...
  <link rel="shortcut icon" href="{{asset('/public/images/products/thumbs/icon.png')}}" type="image/jpg" />
  <meta charset="utf-8">
  ...
  <link href="~/public/css/megamenu.css" rel="stylesheet" type="text/css"/>
  <script src="~/public/js/megaMenu.js" type="text/javascript"></script>
  <style>
