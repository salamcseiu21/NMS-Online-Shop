...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{asset('/')}}" class="logo">
      ...
      <span class="logo-lg"><b>Home</b>NMS</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('/public/images/admin')}}/{{ $u->image }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                       {{$u->name}}
                       
                      </h4>
                      <p>{{$row->replay_message}}</p>
                    </a>
                  </li>
                  <!-- end message -->
              ...
              <li class="footer"><a href="{{url('/view-message.user')}}">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset("/public/images/admin")}}/{{ Auth::user()->image }}" class="user-image" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('/my-orders')}}"><i class="fa fa-circle-o"></i> All Orders</a></li>
            <li><a href="{{asset('/my-pending-orders')}}"><i class="fa fa-circle-o"></i> Pending Orders</a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>My Activity</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i> All Orders</a></li>
            <li><a href="../../index2.html"><i class="fa fa-circle-o"></i> Pending Orders</a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('/view-message.user')}}"><i class="fa fa-circle-o"></i>View Message</a></li>
            <li><a href="{{url('/send-message.user')}}"><i class="fa fa-circle-o"></i>Send Message</a></li>
