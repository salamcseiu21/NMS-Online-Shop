      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
               <li class="active"><a href="{{asset('/product-list.nm')}}"><i class="fa fa-circle-o"></i> Product List </a></li>
            <li ><a href="{{asset('/add-product.nm')}}"><i class="fa fa-circle-o"></i> Add Product</a></li>
           
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Manage Sub Category</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">  <li class="active"><a href="{{asset('/sub-category-list.nm')}}"><i class="fa fa-circle-o"></i>Sub Category List</a></li>
            <li><a href="{{asset('/add-sub-category.nm')}}"><i class="fa fa-circle-o"></i> Add Sub Category</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{asset('/order-details.nm')}}"><i class="fa fa-circle-o"></i> All Orders</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('/send-mail')}}"><i class="fa fa-circle-o"></i> Send Mail</a></li>
            <li><a href="{{url('/messages')}}"><i class="fa fa-circle-o"></i>Reply Message</a></li>
          </ul>
        </li>
